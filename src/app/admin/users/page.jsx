...
export default function AdminListPage() {
  ...
  // SOLUSI: Menambahkan state pemancing refresh
  const [refreshTrigger, setRefreshTrigger] = useState(0);

  useEffect(() => {
    // Fungsi fetch dimasukkan ke DALAM useEffect agar linter React tenang
    ...
    fetchAdmins();
  }, [refreshTrigger]); // Tabel akan otomatis ter-refresh jika nilai refreshTrigger berubah
  ...
  const handleDelete = async (id, username) => {
    ...
    if (res.ok) {
      // Alih-alih memanggil fungsi manual, kita pancing useEffect untuk berjalan lagi
